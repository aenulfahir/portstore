  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        BottomNavigationBarItem(icon: SvgPicture.asset('assets/icons/explore.svg'),label: 'Categories',),
        BottomNavigationBarItem(icon: SvgPicture.asset('assets/icons/shop.svg'),label: 'Store',),
